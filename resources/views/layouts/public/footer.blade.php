                        <div id="kt_app_footer" class="app-footer d-flex flex-column flex-md-row align-items-center flex-center flex-md-stack py-2 py-lg-4">
                            <div class="text-gray-900 order-2 order-md-1">
                                ...
                                <a href="#" target="_blank" class="text-gray-800 text-hover-primary">SBA</a>
                            </div>
    ...
    <script src="{{ asset('assets/landing/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <script src="{{ asset('assets/landing/js/widgets.bundle.js') }}"></script>
    <script src="{{ asset('assets/landing/js/custom/widgets.js') }}"></script>
</body>
</html>
