        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box mb-0 d-sm-flex align-items-center justify-content-between">
                    <h2 class="mb-sm-0 m-0 font-size-18 page-title">PPE</h2>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                            <li class="breadcrumb-item">PPE</li>
                                ...
                                <div class="col-9">
                                    <div class="row row-cols-lg-auto g-3 align-items-center">
                                        ...
                                        <div class="col-12 col-sm-12">
                                            <a href="/ppe/new" class="btn btn-md btn-primary btn-float" style="margin-top:;">Add New</a>
                                        </div>
                            ...
                            <div class="col-md-12 responsive mt--2">
                                <table id="table" class="table table-hover data-table table-striped-columns dataTable" style="width:100%;">
                                    <thead class="table-light">
                                        <tr>
                                            <th width="40">ID</th>
                                            <th width="200">Goods</th>
                                            <th width="400">Desription</th>
