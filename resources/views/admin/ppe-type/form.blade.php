                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-xl-8 col-sm-12">
                            ...
                            <form action="/ppe/store" method="post" class="needs-validation">
                                @csrf
                                <input type="hidden" name="id" class="form-control" id="id" value="{{ @$data->id }}">

                                <div class="row mb-4">
                                    <label for="badge" class="col-sm-3 col-form-label">Goods</label>
                                    <div class="col-sm-5">
                                        <input name="goods" class="form-control @error('goods') is-invalid @enderror" value="{{ old('goods', @$data->goods) }}" placeholder="Goods">
                                        @if ($errors->has('goods'))
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <p class="text-muted mb-2">Switch Knots to Active or Inactive</p>
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-sm-9">
                                        ...
                                        <a href="/ppe" class="btn btn-light w-md">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
