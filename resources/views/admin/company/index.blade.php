        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box mb-0 d-sm-flex align-items-center justify-content-between">
                    <h2 class="mb-sm-0 m-0 font-size-18 page-title">Company</h2>
                                ...
                                <div class="col-9">
                                    <div class="row row-cols-lg-auto g-3 align-items-center">
                                        ...
                                        <div class="col-12 col-sm-12">
                                            <a href="/company/new" class="btn btn-md btn-primary btn-float" style="margin-top:;">Add New</a>
                                        </div>
