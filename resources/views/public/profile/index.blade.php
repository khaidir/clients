                ...
                <div class="d-flex flex-column flex-row-fluid">
                    ...
                    <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-6 pb-18 py-lg-13">
                        <div class="page-title d-flex align-items-center me-3">
                            ...
                            <h1 class="page-heading d-flex text-white fw-bolder fs-2 flex-column justify-content-center my-0"> Product Form <span class="page-desc text-white opacity-50 fs-6 fw-bold pt-4"> Page Description </span>
                            </h1>
                        </div>
