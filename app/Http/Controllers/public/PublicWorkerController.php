    ...
    public function getData(Request $request, $id)
    {
        ...
        return DataTables::of($sia)
            ->addColumn('action', function ($row) {
                return '
                    <a class="btn btn-sm btn-primary edit" href="/contracts/worker/edit/' . $row->id . '"><i class="bx bx-pencil"></i></a>
                    <a class="btn btn-sm btn-success edit" href="/contracts/worker/detail/' . $row->id . '">Detail</a>
